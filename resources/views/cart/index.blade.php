...
<section class="py-20 px-4 sm:px-6 lg:px-8 bg-secondary min-h-screen">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="text-center mb-12">
            <h1 class="text-4xl font-bold mb-4 uppercase tracking-tight">Keranjang Belanja</h1>
            <p class="text-gray-300">Tinjau item Anda dan lanjutkan ke pembayaran</p>
        </div>
            ...
            <div class="lg:w-80">
                <div class="bg-primary border border-gray-800 p-6 sticky top-4">
                    ...
                    <div class="text-center mb-6">
                        ...
                        <p class="text-gray-400 text-sm mt-1">Paling disukai oleh pelanggan kami</p>
                    </div>
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <div class="flex items-center space-x-2 mt-1">
                                        ...
                                        <div class="flex items-center text-yellow-400">
                                            ...
                                            <span class="text-xs ml-1">Terlaris</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-800 text-center">
                        <p class="text-gray-400 text-sm mb-3">Bergabung dengan ribuan pelanggan puas</p>
                        <a href="{{ route('catalogue') }}" 
